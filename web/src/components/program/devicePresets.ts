...
export const PRESET_COMMAND_MAP: Record<string, { arm: number; disarm: number; params?: Record<string, number> }> = {
  ...
  primaryCue:    { arm: 301,  disarm: 300,  params: { frequency: 371, duration: 372, leverFilter: 378 } },
  secondaryCue:  { arm: 311,  disarm: 310,  params: { frequency: 381, duration: 382, leverFilter: 388 } },
  primaryPump:   { arm: 401,  disarm: 400,  params: { duration: 472,  leverFilter: 478 } },
  secondaryPump: { arm: 411,  disarm: 410,  params: { duration: 482,  leverFilter: 488 } },
